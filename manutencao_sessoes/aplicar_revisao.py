...
SRC = Path(r"C:\Users\mauri\AppData\Local\Temp\claude\c--Users-mauri-ProjetoConversor\d48cbf3a-d817-49bc-903a-c46866886b18\tasks\wy2uo568n.output")
...
(ART / "revisao_meritoria_veredito_20260823.json").write_text(
...
out = ART / f"revisao_meritoria_aplicacao_{'apply' if APPLY else 'dry'}_{STAMP}.json"
